...
<execution_context>
@/root/.openclaw/workspace/.claude/get-shit-done/workflows/new-workspace.md
@/root/.openclaw/workspace/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/root/.openclaw/workspace/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
