...
<execution_context>
@/root/.openclaw/workspace/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @/root/.openclaw/workspace/.claude/get-shit-done/workflows/next.md end-to-end.
</process>
