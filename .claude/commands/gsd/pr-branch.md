...
<execution_context>
@/root/.openclaw/workspace/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/root/.openclaw/workspace/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
