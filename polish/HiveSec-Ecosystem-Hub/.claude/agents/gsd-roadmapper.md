...
Reference full template: `/root/.openclaw/workspace/polish/HiveSec-Ecosystem-Hub/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/.openclaw/workspace/polish/HiveSec-Ecosystem-Hub/.claude/get-shit-done/templates/state.md`.
