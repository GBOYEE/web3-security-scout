...
<execution_context>
@/root/.openclaw/workspace/polish/openclaw/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/root/.openclaw/workspace/polish/openclaw/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
