...
- **Global scope**: `/root/.openclaw/workspace/polish/openclaw/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/root/.openclaw/workspace/polish/openclaw/.claude/notes/`)
...
2. Glob `/root/.openclaw/workspace/polish/openclaw/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/root/.openclaw/workspace/polish/openclaw/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/root/.openclaw/workspace/polish/openclaw/.claude/notes/` — works in any directory
