...
- Usage: Reference from command with `@/root/.openclaw/workspace/polish/portfolio/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /root/.openclaw/workspace/polish/portfolio/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /root/.openclaw/workspace/polish/portfolio/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
