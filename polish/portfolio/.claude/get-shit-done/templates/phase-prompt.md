...
<!-- For checkpoint task examples and patterns, see @/root/.openclaw/workspace/polish/portfolio/.claude/get-shit-done/references/checkpoints.md -->
...
See `/root/.openclaw/workspace/polish/portfolio/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/root/.openclaw/workspace/polish/portfolio/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/root/.openclaw/workspace/polish/portfolio/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
