...
<required_reading>
@/root/.openclaw/workspace/polish/web3-security-scout/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/root/.openclaw/workspace/polish/web3-security-scout/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
